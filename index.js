function szamolas()
{
    document.getElementById('sovany').classList.remove('kijeloles');
    document.getElementById('normal').classList.remove('kijeloles');
    document.getElementById('tulsuly').classList.remove('kijeloles');
    document.getElementById('tulsuly_1').classList.remove('kijeloles');
    document.getElementById('tulsuly_2').classList.remove('kijeloles');
    document.getElementById('tulsuly_3').classList.remove('kijeloles');
